...
NumberSelected::NumberSelected(QWidget *parent) : QWidget(parent),
...
void NumberSelected::resizeEvent(QResizeEvent *e)
{
    m_nItemHeight = this->height() / 5;
...
void NumberSelected::drawListItem(QPainter *painter)
{
    ...
    QRect rect(0, m_nItemHeight * 2, this->width(), m_nItemHeight);
    ...
    rect = QRect(0, m_nOffset - m_nItemHeight, this->width(), m_nItemHeight);
...
//////////////////////////////////////////////////////////////////////
QtDateTimeConfig::QtDateTimeConfig(QWidget *parent) : QWidget(parent)
{
    InitWidget();
}
...
void QtDateTimeConfig::setConfigFormat(QtDateTimeConfig::ConfigFromat format)
{
    ...
    if (DateFormat == format) {
        ...
        m_labelTitle->setText(date.toString("yyyy年MM月dd日"));
        ...
        m_labelTitle->setText(time.toString("hh:mm:ss"));
...
void QtDateTimeConfig::SltNumberChanged()
{
    if (DateFormat == m_format) {
        ...
        m_labelTitle->setText(date.toString("yyyy - MM - dd"));
