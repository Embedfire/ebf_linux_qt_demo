...
QT_MOC_LITERAL(1, 16, 18), // "signalAboutClicked"
QT_MOC_LITERAL(2, 35, 0) // ""

    },
    "StatusBarWidget\0signalAboutClicked\0"
};
...
void StatusBarWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signalAboutClicked(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&StatusBarWidget::signalAboutClicked)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject StatusBarWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_StatusBarWidget.data,
      qt_meta_data_StatusBarWidget,  qt_static_metacall, nullptr, nullptr}
};
