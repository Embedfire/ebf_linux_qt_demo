...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        CameraConfig *_t = static_cast<CameraConfig *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject CameraConfig::staticMetaObject = {
    { &QtAnimationWidget::staticMetaObject, qt_meta_stringdata_CameraConfig.data,
      qt_meta_data_CameraConfig,  qt_static_metacall, nullptr, nullptr}
};
