...
void QtEqualizeSliderBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QtEqualizeSliderBar *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject QtEqualizeSliderBar::staticMetaObject = { {
    QMetaObject::SuperData::link<QtSliderBar::staticMetaObject>(),
    qt_meta_stringdata_QtEqualizeSliderBar.data,
    qt_meta_data_QtEqualizeSliderBar,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<EqualizeWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject EqualizeWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_EqualizeWidget.data,
    qt_meta_data_EqualizeWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
