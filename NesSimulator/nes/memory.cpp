...
void memory_writeb(word address, byte data)
{
    ...
    switch (address >> 13) {
	case 0: cpu_ram_write(address & 0x07FF, data); break;
	case 1: ppu_io_write(address, data); break;
	case 2: psg_io_write(address, data); break;
	case 3: cpu_ram_write(address & 0x1FFF, data); break;
        default: mmc_write(address, data);
    }
}
